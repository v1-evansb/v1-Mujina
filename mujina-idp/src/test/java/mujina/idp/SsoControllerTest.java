...
public class SsoControllerTest extends AbstractIntegrationTest {
  ...
  private static final String APP_ROLES_ATTRIBUTE = "APP_ROLES";
  ...
  public void setup () {
    ...
    idpConfiguration.putAttribute(ACCOUNTS_ATTRIBUTE, "ABC");
    idpConfiguration.putAttribute(APP_ROLES_ATTRIBUTE, "SuperUser:PowerUser");
  }
  ...
  private void doSingleSignOn(boolean post) throws Exception {
    ...
    assertThat(String.format("SAML response should contain the %s attribute", ACCOUNTS_ATTRIBUTE), samlResponse.contains(ACCOUNTS_ATTRIBUTE));
    assertThat(String.format("SAML response should contain the %s attribute", APP_ROLES_ATTRIBUTE), samlResponse.contains(APP_ROLES_ATTRIBUTE));
    assertThat("SAML response should not contain a test-attribute attribute", !samlResponse.contains("test-attribute"));
  }
